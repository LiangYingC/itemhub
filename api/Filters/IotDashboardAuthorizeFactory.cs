...
{
    public class IotDashboardAuthorizeFactory : ActionFilterAttribute, IFilterFactory
    {
        public bool IsReusable => true;
        public IOT_ROLE[] _iotRoles;
        public AUTH_TYPE _authType = AUTH_TYPE.COMMON;
        public IotDashboardAuthorizeFactory(AUTH_TYPE type = AUTH_TYPE.COMMON, IOT_ROLE[] roles = null)
        {
            this._authType = type;
