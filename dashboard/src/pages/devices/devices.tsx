        ...
        <div className="devices" data-testid="Devices">
            ...
            <div className="bg-white shadow-sm mx-3 mx-sm-0 mx-xl-45 mt-4 mt-sm-0 p-3 p-sm-45 rounded-8">
                <div className="d-flex filter">
                    <input
                        placeholder="搜尋裝置"
                        className="form-control border border-black-opacity-15 border-end-0 rounded-start "
                        type="text"
                    />
                    <button
                        className="btn btn-outline-black-opacity-15 border-start-0 rounded-end"
                        type="button"
                    >
                        <img
                    ...
                    <>
                        <div className="mt-3 mt-sm-45">
                            <div className="d-none d-sm-block">
                                <div className="row bg-black bg-opacity-2 text-black text-opacity-45 border-bottom border-color-black-opacity-9 h6 py-25 px-3 m-0">
                                    <div className="col-4">裝置名稱 / ID</div>
                            ...
                            {devices.map(
                                ({ id, deviceId, name, createdAt, online }) => (
                                    <div
                                        className="row border-bottom border-color-black-opacity-9 p-0 py-sm-4 px-sm-3 mx-0 "
                                        key={id}
                                        title={`建立時間: ${createdAt}`}
                                    >
                                        <div className="col-12 col-sm-4 row text-break mx-0 px-0 px-sm-25">
                                            <div className="d-sm-none col-4 bg-black bg-opacity-2 text-black text-opacity-45 p-3">
                                                裝置名稱 / ID
                                            </div>
                                        ...
                                        <div className="col-12 col-sm-1 row mx-0 px-0 px-sm-25">
                                            <div className="d-sm-none col-4 bg-black bg-opacity-2 text-black text-opacity-45 p-3">
                                                狀態
                                            </div>
                                            <div className="col-8 col-sm-12 p-3 p-sm-0">
